...
export default function Diary() {
  ...
  const { data: chatsData, loading: chatsLoading } = useQuery(CHATS_QUERY, {
  ...
  if (chatsLoading || messagesLoading) return <div className="text-text-primary">Loading...</div>
      ...
      <div className="max-w-4xl mx-auto">
        <Card>
          <p className="text-text-secondary text-center py-8">
            Дневник не найден. Пожалуйста, создайте дневник.
          </p>
        </Card>
      </div>
    )
